...
import cn.edu.fudan.ee.glasscameracontrol.GlassCameraControl;
...
//    	setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("icon.png")));
    ...
    private WindowListener mWindowListener = new WindowListener() {
        ...
        public void windowClosed(WindowEvent arg0) {
            GlassCameraControl.alreadyProjectToPC = false;// 告诉GlassCameraControl，其按钮恢复为等待"Enable projecting"状态
        }
    ...
    public class MonitorThread extends Thread {
        ...
        public void run() {
            ...
            if (GlassCameraControl.mDevice != null)
            {
                try
                {
        ...
        private FBImage getDeviceImage() throws IOException, TimeoutException, AdbCommandRejectedException {
            ...
            if (success)
            {
                try
                {
                    tmpRawImage = GlassCameraControl.mDevice.getScreenshot();
